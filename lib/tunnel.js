...
var defaultOptions = {
	// when set to `true`, connected tunnel will connect to local web-server
	localConnect: true
};
...
module.exports = class Tunnel extends EventEmitter {
	constructor(serverUrl, options, callback) {
		...
		this.socket.localConnect = this.options.localConnect;
	}
...
function setupLocalConnection() {
	...
	this.pipe(gzip(this.local)).pipe(this);
