...
module.exports = class WebSocketClient extends EventEmitter {
	constructor(config) {
		...
		var tlsOptions = extend(defaultConfig, config.tlsOptions || {});
		this.config = extend(defaultConfig, config);
		this.config.tlsOptions = tlsOptions;
	...
	connect(requestUrl, protocols, origin, headers, extraRequestOptions) {
		...
		if (extraRequestOptions) {
			assign(requestOptions, extraRequestOptions);
		}
		...
		if (this.secure) {
			assign(requestOptions, this.config.tlsOptions);
		}
		...
		var handleRequestUpgrade = function(response, socket, head) {
			self._req = null;
		...
		.once('upgrade', handleRequestUpgrade)
